...
use cw4::TOTAL_KEY;
use cw_storage_plus::{Item, SnapshotMap, snapshot_names, Strategy, SnapshotNamespaces};
...
pub const MEMBERS: SnapshotMap<&[u8], u64> = SnapshotMap::new(snapshot_names!("members"), Strategy::EveryBlock);
