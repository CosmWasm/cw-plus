...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/aragon/aragon-chain/tree/master/CONTRIBUTING.md#updating-documentation)
...
The documentation for aragon-chain is hosted at https://docs.chain.aragon.org//

built from the files in this (`/docs`) directory for
[master](https://github.com/aragon/aragon-chain/tree/master/docs).
