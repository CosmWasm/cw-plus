...
//
// impl BankRouter {
//     pub fn new<B: Bank + 'static>(bank: B) -> Self {
//         BankRouter {
//             bank: Box::new(bank),
//         }
//     }
//
//     // this is an "admin" function to let us adjust bank accounts
//     pub fn set_balance(&self, storage: &mut dyn Storage, account: &Addr, amount: Vec<Coin>) -> Result<(), String> {
//         self.bank
//             .set_balance(storage, account, amount)
//     }
//
//     pub fn query(&self, storage: &dyn Storage, request: BankQuery) -> Result<Binary, String> {
//         self.bank.query(storage, request)
//     }
//
//     pub fn execute(&self, storage: &mut dyn Storage, sender: Addr, msg: BankMsg) -> Result<(), String> {
