...
use cw4::{
    Cw4HandleMsg, Cw4QueryMsg, ProposalListResponse, ProposalResponse, ThresholdResponse,
...
fn main() {
    ...
    export_schema_with_title(&mut schema_for!(Cw4HandleMsg), &out_dir, "HandleMsg");
    export_schema_with_title(&mut schema_for!(Cw4QueryMsg), &out_dir, "QueryMsg");
